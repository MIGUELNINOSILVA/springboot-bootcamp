...
class SecretsSource {
    ...
    resolve(secretReference) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return JSON.parse(yield __classPrivateFieldGet(this, _SecretsSource_inner, "f").core.invoke(invocationConfig));
        });
    }
}
exports.SecretsSource = SecretsSource;
